...
const char *host = "192.168.1.8";//Dia chi IP may
...
void truyen_len_serve_slave1()
{
  ...
  http.begin("http://192.168.1.8:80/doan/esp.php");              //duong dan file php... vi dang ket noi wifi nen phai lay ip may thay vi localhost
