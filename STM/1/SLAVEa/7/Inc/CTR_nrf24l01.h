...
#include "stm32f1xx_hal.h"
 ...
 // dây là phan dinh nghia chan ket noi voi module
...
//#define CTR_TX_ADR_WIDTH    5      // dia chi truyen co 5 bytes
//#define CTR_RX_ADR_WIDTH    5      //dia chi nhan co 5 bytes
#define CTR_TX_ADR_WIDTH    5      // dia chi truyen co 5 bytes
#define CTR_RX_ADR_WIDTH    5      //dia chi nhan co 5 bytes
#define CTR_TX_PLOAD_WIDTH  32    //khung truyen toi da 32 bytes
#define CTR_RX_PLOAD_WIDTH  32    //khung nhan toi da 32 bytes
...
#define CTR_NOP             0xFF     
//dinh nghia cac thanh ghi theo datasheet
