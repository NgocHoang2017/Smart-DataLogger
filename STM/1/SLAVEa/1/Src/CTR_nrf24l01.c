...
unsigned char  CTR_TX_ADDRESS[CTR_TX_ADR_WIDTH]= {0x68,0x31,0x08,0x10,0x01};   //5 bytes
unsigned char  CTR_RX_ADDRESS[CTR_RX_ADR_WIDTH]= {0x68,0x31,0x08,0x10,0x01};  //5 bytes
